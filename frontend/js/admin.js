            ...
            response.json().then(function (messages) {
                ...
                messages.forEach(message => {
                    if (message.moderate === true) {
                        ...
                        html = html + '<div class="message-container bg-secondary bg-gradient pb-2"><div class="message-header card-header"><div class="d-flex align-items-center"> <div class="mr-2"><img class="rounded-circle" height="50" width="50" src="' + message.user.image + '" alt=""></div> <div class="h5 m-0 text-left text-muted">@' + message.user.username + '</div> </div> </div></div> <div class="message-body card-body bg-secondary bg-gradient p-2"> <div class="text-muted h7 mb-2"> <i class="fa fa-clock-o"></i> Posté le : ' + message.createdAt + ' </div> <p class="message-text text-muted">' + message.content + '</p> <div class="authorize d-flex justify-content-end"> <button data-id="'+ message.message_id +'" cl class="allowMessage btn btn-success"<i class="bi bi-dash-circle-fill">Autoriser</i></button></div></div></div>';
                        document.getElementById("moderateMessage").innerHTML = html;
           
                    }else{

                    html = html +  ' <div class="message-container"><div class="message-header card-header"><div class="d-flex align-items-center"> <div class="mr-2"><img class="rounded-circle" height="50" width="50" src="' + message.user.image + '" alt=""></div> <div class="h5 m-0 text-left">@' + message.user.username + '</div> </div> </div> </div> <div class="message-body card-body p-2"> <div class="text-muted h7 mb-2"> <i class="fa fa-clock-o"></i> Posté le : ' + message.createdAt + ' </div> <p class="message-text">' + message.content + '</p><div class="moderate d-flex justify-content-end"> <button data-id="'+ message.message_id +'" class="moderateMessage btn btn-danger"<i class="bi bi-dash-circle-fill">Modérer</i></button></div></div></div>'
